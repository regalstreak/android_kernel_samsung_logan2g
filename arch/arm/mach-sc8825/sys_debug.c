...
{
#if defined(CONFIG_MACH_AMAZING) || defined(CONFIG_MACH_KYLETD) || defined(CONFIG_MACH_VASTOI) || defined(CONFIG_MACH_GARDA) || defined(CONFIG_MACH_KYLEVE) || defined(CONFIG_MACH_LOGAN)
	if (val > 0) cp_abort();
#endif
	return 0;
}

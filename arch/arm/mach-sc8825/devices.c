...
struct platform_tps61158_backlight_data tps61158_backlight_data = {
	.max_brightness = 255,
	.dft_brightness = 160,
	.ctrl_pin = 24,
};
...
struct platform_device sprd_backlight_device = {
	...
	.id 		= -1,
	.dev 	= {
		.platform_data  =  &tps61158_backlight_data,
	},
};
...
struct platform_device ktd253_backlight_device = {
	.name           = "panel",
	.id             =  -1,
};
...
*/
#if defined(CONFIG_MACH_SP8825EB) || defined(CONFIG_MACH_SP8825EA) || defined(CONFIG_MACH_SP6825GA) || defined(CONFIG_MACH_SP6825GB) || defined(CONFIG_MACH_SP8810i1)
...
#elif defined(CONFIG_MACH_GARDA) || defined(CONFIG_MACH_CS02) || defined(CONFIG_MACH_KYLEVE) || defined(CONFIG_MACH_LOGAN)

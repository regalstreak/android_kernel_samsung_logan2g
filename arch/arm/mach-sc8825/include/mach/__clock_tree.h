...
SCI_CLK_ADD(clk_i2c0, 0, REG_GLB_GEN0, BIT(4),
	0, 0, 0, 0,
	1, &clk_apb);

SCI_CLK_ADD(clk_i2c1, 0, REG_GLB_GEN0, BIT(29),
	0, 0, 0, 0,
	1, &clk_apb);

SCI_CLK_ADD(clk_i2c2, 0, REG_GLB_GEN0, BIT(30),
	0, 0, 0, 0,
	1, &clk_apb);

SCI_CLK_ADD(clk_i2c3, 0, REG_GLB_GEN0, BIT(31),
	0, 0, 0, 0,
	1, &clk_apb);

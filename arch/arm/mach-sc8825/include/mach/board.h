...
#include <mach/gpio.h>
#ifdef CONFIG_MACH_SP8810i1
#include <mach/gpio-sp8810i1.h>
#endif

#ifdef CONFIG_MACH_LOGAN
#include <mach/gpio-logan.h>
#endif
...
#include <mach/gpio-cs02.h>
#endif
#ifdef CONFIG_MACH_KYLEVE
#include <mach/gpio-kyleve.h>
#endif
#include "memory.h"
...
/*	#define SPRD_ION_SIZE   (24*1024*1024) // 1280x720 H264 HW Decoding needs 24M*/
	...
	#ifdef CONFIG_CAMERA_ROTATION
		#ifdef CONFIG_SENSOR_OUTPUT_RAW
			#define SPRD_ION_SIZE   (38*1024*1024)
		#else
			#define SPRD_ION_SIZE   (38*1024*1024)
		#endif
	#else
...
#define SPRD_EMC_TRAINING_MEM_BASE	(0xA0000000)
#define SPRD_EMC_TRAINING_MEM_SIZE	(0x1000)

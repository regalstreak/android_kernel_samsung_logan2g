...
#if (defined(CONFIG_SENSORS_K3DH) && (defined(CONFIG_MACH_CS02)||defined(CONFIG_MACH_SP8810i1) ||defined(CONFIG_MACH_LOGAN) ))
...
static struct i2c_board_info i2c2_boardinfo[] = {
...
#ifdef CONFIG_SENSORS_K3DH
	{
		...
		#if (defined (CONFIG_MACH_CS02)||defined (CONFIG_MACH_SP8810i1)||defined (CONFIG_MACH_LOGAN))

...
static struct stc311x_platform_data stc3115_data = {
		...
		.Vmode= 0,       /*REG_MODE, BIT_VMODE 1=Voltage mode, 0=mixed mode */
  		...
  		.CC_cnf = 252,      /* nominal CC_cnf, coming from battery characterisation*/
  		.VM_cnf = 256,      /* nominal VM cnf , coming from battery characterisation*/
		...
		.CapDerating[6] = 250,   /* capacity derating in 0.1%, for temp = -20°C */
  		.CapDerating[5] = 80,   /* capacity derating in 0.1%, for temp = -10°C */
		.CapDerating[4] = 60,   /* capacity derating in 0.1%, for temp = 0°C */
		.CapDerating[3] = 0,   /* capacity derating in 0.1%, for temp = 10°C */
		.CapDerating[2] = -10,   /* capacity derating in 0.1%, for temp = 25°C */
		.CapDerating[1] = -20,   /* capacity derating in 0.1%, for temp = 40°C */
		.CapDerating[0] = -20,   /* capacity derating in 0.1%, for temp = 60°C */

  		.OCVOffset[15] = 23,    /* OCV curve adjustment */
		.OCVOffset[14] = 23,   /* OCV curve adjustment */
		.OCVOffset[13] = 14,    /* OCV curve adjustment */
		.OCVOffset[12] = 14,    /* OCV curve adjustment */
		.OCVOffset[11] = 0,    /* OCV curve adjustment */
		.OCVOffset[10] = 14,    /* OCV curve adjustment */
		.OCVOffset[9] = -17,     /* OCV curve adjustment */
		.OCVOffset[8] = 1,      /* OCV curve adjustment */
		.OCVOffset[7] = -5,      /* OCV curve adjustment */
		.OCVOffset[6] = -17,    /* OCV curve adjustment */
		.OCVOffset[5] = -28,    /* OCV curve adjustment */
		.OCVOffset[4] = -50,     /* OCV curve adjustment */
		.OCVOffset[3] = -27,    /* OCV curve adjustment */
		.OCVOffset[2] = -35,     /* OCV curve adjustment */
		.OCVOffset[1] = -122,    /* OCV curve adjustment */
		.OCVOffset[0] = -72,     /* OCV curve adjustment */


    .OCVOffset2[15] = -31,    /* OCV curve adjustment */
		.OCVOffset2[14] = -12,   /* OCV curve adjustment */
		.OCVOffset2[13] = -18,    /* OCV curve adjustment */
		.OCVOffset2[12] = -11,    /* OCV curve adjustment */
		.OCVOffset2[11] = -26,    /* OCV curve adjustment */
		.OCVOffset2[10] = -39,    /* OCV curve adjustment */
		.OCVOffset2[9] = -7,     /* OCV curve adjustment */
		.OCVOffset2[8] = -9,      /* OCV curve adjustment */
		.OCVOffset2[7] = -17,      /* OCV curve adjustment */
		.OCVOffset2[6] = -32,    /* OCV curve adjustment */
		.OCVOffset2[5] = -64,    /* OCV curve adjustment */
		.OCVOffset2[4] = -33,     /* OCV curve adjustment */
		.OCVOffset2[3] = -38,    /* OCV curve adjustment */
		.OCVOffset2[2] = -160,     /* OCV curve adjustment */
		.OCVOffset2[1] = -200,    /* OCV curve adjustment */
...
#if (defined(CONFIG_SENSORS_K3DH) && defined(CONFIG_MACH_NEVISTD))
#define GPIO_ACC_INT (92)		/* RFCTL_2/GPIO92 */
...
static struct i2c_board_info i2c0_boardinfo[] = {
...
#if defined  (CONFIG_SENSORS_K3DH)
	{
		...
		.platform_data = &k3dh_platform_data, /*GPIO92*/
		#endif
	},
#endif
...
#elif defined(CONFIG_TOUCHSCREEN_MMS134S_TS) || defined(CONFIG_TOUCHSCREEN_ZINITIX_ZXT)
...
static unsigned int headset_get_button_code_board_method(int v)
{
	static struct headset_adc_range {
		...
		{ 0x0000, 0x008c, KEY_MEDIA},
		{ 0x008d, 0x00129, KEY_VOLUMEUP},
		{ 0x0012a, 0x0237, KEY_VOLUMEDOWN },
	};

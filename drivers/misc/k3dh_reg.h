...
#if defined(CONFIG_MACH_NEVISTD) || defined(CONFIG_MACH_GARDA) || defined(CONFIG_MACH_KYLEVE)|| defined(CONFIG_MACH_LOGAN)
#define USES_MOVEMENT_RECOGNITION
#endif
 /* Need to enable at least one of these INT PIN to use interrupt */

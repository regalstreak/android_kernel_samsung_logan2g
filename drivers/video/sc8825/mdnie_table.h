...
static LCM_Init_Code cabc_on02[] = { /* 0x51 */
{LCM_SEND(6), {4,0,0x51,0xFF,0x3C,0x00 /* The Last 0x00 : Sequence End Mark */}}
};

static LCM_Init_Code cabc_on03[] = { /* 0x53 */
{LCM_SEND(6), {4,0,0x53,0x24,0x08,0x00 /* The Last 0x00 : Sequence End Mark */}}
};
/* - CABC on Sequence */

/* + CABC Mode Sequence */
static LCM_Init_Code cabc_ui[] = { /* 0x55 */
{LCM_SEND(6), {4,0,0x55,0x01,0x1D,0x00 /* The Last 0x00 : Sequence End Mark */}}
};

static LCM_Init_Code cabc_still[] = { /* 0x55 */
{LCM_SEND(6), {4,0,0x55,0x02,0x1E,0x00 /* The Last 0x00 : Sequence End Mark */}}
};
/* - CABC Mode Sequence */

/* + CABC off Sequence */
static LCM_Init_Code cabc_off[] = { /* 0x55 */
{LCM_SEND(6), { 4,0, 0x55,0x00,0x2C,0x00 /* The Last 0x00 : Sequence End Mark */}}
};
/* - CABC off Sequence */


static LCM_Init_Code negative_tuning[] = {  
{LCM_SEND(116), 
 { 114,0, 0xE6,	
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code video_tuning[] = {   
{LCM_SEND(116), 
 { 114,0, 0xE6,	
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code video_outdoor_tuning[] = {  
{LCM_SEND(116), 
 { 114,0, 0xE6,		                                                                
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code video_warm_outdoor_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,		  
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code video_warm_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,	  
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code video_cold_outdoor_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,	
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code video_cold_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,	 
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code ui_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,		                                                                  
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code gallery_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,	
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code camera_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,	                                                               
0x5A, //password 5A
0x00, //mask 000
...
static LCM_Init_Code camera_outdoor_tuning[] = {
{LCM_SEND(116), 
 { 114,0, 0xE6,	    
0x5A, //password 5A
0x00, //mask 000

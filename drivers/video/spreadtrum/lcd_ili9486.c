...
printk("ili9486_init start\n");
#ifdef CONFIG_MACH_NEVISTD
	send_cmd(0xC0);    /*power setting sequnce*/
	send_data(0x0B);
	send_data(0x0B);
	...
	send_cmd(0x2A);   /*Display parameter setting*/
	send_data(0x00);
	send_data(0x00);
	send_data(0x01);
	send_data(0x3F);
	...
	send_cmd(0xF8);   /*Gamma Setting Sequence*/
	send_data(0x21);
	send_data(0x06);
...
printk("ili9486_enter_sleep is_sleep=%d\n",is_sleep);

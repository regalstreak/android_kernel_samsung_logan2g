...
#define HEADSET_BUTTON_GPIO_DEBOUNCE_SW 1000
#endif

 /* ffkaka */
#define HEADSET_MICBIAS_GPIO	143
#define HEADSET_COM_DETECT_GPIO	138
#define HEADSET_ADC_3POLE_MAX	0x4ff
#define HEADSET_ADC_4POLE_MAX	0xd10
...
//extern int sprd_codec_auxmic_bias_control(int on);
...
static unsigned int headset_get_button_code(int v)
{
	...
	pr_info("headset_get_button_code headset_get_button_code_board_method [0x%x] \n",(unsigned int)headset_get_button_code_board_method);

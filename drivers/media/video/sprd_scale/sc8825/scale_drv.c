...
static int32_t _scale_set_sc_coeff(void)
{
	...
	printk("SCALE DRV: _scale_set_sc_coeff start! \n");
	...
	printk("SCALE DRV: reg list 0x20900200--1--2090020C : %x %x %x %x  \n",REG_RD(REG_AHB_AHB_CTL0),REG_RD(REG_AHB_AHB_CTL1),REG_RD(REG_AHB_AHB_CTL2),REG_RD(REG_AHB_AHB_CTL3));
	...
	printk("SCALE DRV: reg list 0x20900200--2--2090020C : %x %x %x %x  \n",REG_RD(REG_AHB_AHB_CTL0),REG_RD(REG_AHB_AHB_CTL1),REG_RD(REG_AHB_AHB_CTL2),REG_RD(REG_AHB_AHB_CTL3));
	} while (0 != ((1 << 6) & REG_RD(SCALE_BASE))); 
	
	kfree(tmp_buf);

	printk("SCALE DRV: _scale_set_sc_coeff end! \n");
	return SCALE_RTN_SUCCESS;	
}

...
typedef struct sensor_set_voltage_tag {
	SENSOR_VDD_VAL_E iodd_val;
	SENSOR_VDD_VAL_E avdd_val;
	SENSOR_VDD_VAL_E dvdd_val;
} SENSOR_SET_VOLTAGE_T, *SENSOR_SET_VOLTAGE_T_PTR;
...
#define SENSOR_MAIN_I2C_ADDR 0x20
...
#define SENSOR_IO_SET_VOLTAGE		_IOW(SENSOR_IOC_MAGIC, 17,  SENSOR_SET_VOLTAGE_T)

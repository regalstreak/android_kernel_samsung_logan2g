...
/*DPC reg in otp down to xdata*/
    ...
    {0x8F, 0x20},
    {0x92, 0x4c},
    {0x93, 0x00}, /*Full size normal XY_flip case*/
    {0x94, 0xf0},
    {0x95, 0x00}, /*Full size normal XY_flip case*/
    {0x03, 0x00},
...
/*/////////////////////////////////////////*/
    {0x03, 0x10},
    {0x10, 0x00}, /*YUV422-YUYV->03 VYUY->00 */
...
/*/////////////////////////////////////////*/
    ...
    {0x47, 0x00},
    {0x12, 0x40},
    {0x13, 0x40}, /*Ratio WB R gain min*/
    {0x14, 0x48}, /*Ratio WB R gain max*/
    {0x15, 0x40}, /*Ratio WB B gain min*/
    {0x16, 0x48}, /*Ratio WB B gain max*/
    {0x10, 0xB9}, /*enable*/
/*/////////////////////////////////////////*/
/* 1F Page SSD*/
/*/////////////////////////////////////////*/
    ...
    {0x12, 0x40}, /*X Flip 0x40, Normal 0x60*/
    {0x13, 0x14},
    {0x14, 0x10},
    {0x15, 0x00},
...
/*/////////////////////////////////////////*/
    ...
    {0x35, 0x6d}, /*out2 b_min*/
    {0x36, 0x80}, /*out2 b_max*/
...
/*/////////////////////////////////////////*/
    ...
    {0x34, 0x78}, /*LSC 03 Gain B*/
    {0x35, 0x7a}, /*LSC 03 Gain R*/
    ...
    {0x3c, 0x78}, /*LSC 04 Gain B*/
    {0x3d, 0x7a}, /*LSC 04 Gain R*/
    ...
    {0x44, 0x78}, /*LSC 05 Gain B*/
    {0x45, 0x7a}, /*LSC 05 Gain R*/
...
/* D3 Page Adaptive */
/*/////////////////////////////////////////*/
    {0x7c, 0x00}, /*EV max 200fps*/
    {0x7d, 0x04},
    {0x7e, 0xa2},
    {0x7f, 0x86},
    {0x80, 0x00}, /*EV min 1000fps*/
    {0x81, 0x00},
    {0x82, 0xe6},
    {0x83, 0xb6},
    {0x84, 0x78}, /*CTEM max*/
...
LOCAL const SENSOR_REG_T reg_main_preview[]=
{
    {0xff, 0xff},
};

LOCAL const SENSOR_REG_T sr300pc20_640x480_preview_set[]=
{
    {0xff, 0xff},
};

LOCAL SENSOR_REG_T sr300pc20_update_preview_setting[] = {
    {0x03, 0x00},
    {0x01, 0xf1}, /*Sleep on*/
    {0x03, 0x30},
    {0x36, 0xA3}, /*DMA off*/
    ...
    {0x33, 0x00},
    {0x32, 0x01}, /*DMA On*/
    {0xff, 0xc8}, //delay 200ms
    {0xff, 0xff},
};

LOCAL SENSOR_REG_T sr300pc20_snapshot[] = {
    {0x03, 0x00},
    {0x01, 0xf1}, /*Sleep on*/
    {0x03, 0x30},
    {0x36, 0xA3}, /*DMA off*/
...
LOCAL SENSOR_REG_T sr300pc20_night_snapshot[] = {
    {0x03, 0x00},
    {0x01, 0xf1}, /*Sleep on*/
    {0x03, 0x30},
    {0x36, 0xA3}, /*DMA off*/
...
LOCAL SENSOR_REG_T sr300pc20_fireworks_snapshot[] = {
    {0x03, 0x00},
    {0x01, 0xf1}, /*Sleep on*/
    {0x03, 0x30},
    {0x36, 0xA3}, /*DMA off*/
...
LOCAL SENSOR_REG_T sr300pc20_1600x1200_snapshot[] = {
    {0xff, 0xff},
};
LOCAL SENSOR_REG_T sr300pc20_1600x1200_night_snapshot[] = {
    {0xff, 0xff},
};
LOCAL SENSOR_REG_T sr300pc20_1600x1200_fireworks_snapshot[] = {
    {0xff, 0xff},
};
LOCAL SENSOR_REG_T sr300pc20_1280x960_snapshot[] = {
    {0xff, 0xff},
};
LOCAL SENSOR_REG_T sr300pc20_1280x960_night_snapshot[] = {
    {0xff, 0xff},
};
LOCAL SENSOR_REG_T sr300pc20_1280x960_fireworks_snapshot[] = {
    {0xff, 0xff},
};
LOCAL SENSOR_REG_T sr300pc20_get_light_status[] = {
	{0x03, 0x20},
	{0xb1, 0x00},
	{0xff, 0xff}
};
LOCAL SENSOR_REG_T sr300pc20_get_iso_reg[] = {
	{0x03, 0x20},
	{0x50, 0x00},
	{0xff, 0xff}
};
LOCAL SENSOR_REG_T sr300pc20_get_shutterspeed_reg[] = {
	{0x03,0x20},
	{0xa0,0x00},
	{0xa1,0x00},
	{0xa2,0x00},
...
LOCAL SENSOR_REG_T sr300pc20_fps_auto[] ={
  // ==========================================================
  //	Frame Auto
  // ==========================================================
    {0x03, 0x00},
...
LOCAL SENSOR_REG_T sr300pc20_fps_15fix[] ={
	// ==========================================================
	//	Fixed 15 FPS
	// ==========================================================
    {0x03, 0x00},
    ...
    {0xf1, 0x73},
    {0x03, 0x10},
    {0x41, 0x00}, /*DY Offset Off*/
    {0x03, 0xc5},
    {0x12, 0x13}, /*adaptive on_nearBP off*/
    {0x03, 0x00},
    {0xff, 0x7d}, //delay 125ms
    {0x03, 0x00},
    {0x11, 0x93},
    {0x50, 0x00}, /*Hblank 20*/
    {0x51, 0x14},
    ...
    {0x03, 0xc4},
    {0x19, 0x24}, /*Bnd0 Gain*/
    {0x1e, 0x00}, /*Bnd0 100fps*/
    {0x1f, 0x08},
    {0x20, 0x39},
    {0x21, 0x78},
    {0x1a, 0x24}, /*Bnd1 Gain*/
    {0x22, 0x00}, /*Bnd1 50fps*/
    {0x23, 0x10},
    {0x24, 0x72},
    {0x25, 0xf0},
    {0x1b, 0x24}, /*Bnd2 Gain*/
    {0x26, 0x00}, /*Bnd2 33.3fps*/
    {0x27, 0x18},
    {0x28, 0xac},
    {0x29, 0x68},
    {0x03, 0x00},
    {0x13, 0xa8}, /*Fix AE Set On*/
    {0x11, 0x97}, /*Fix Frame On*/
    {0x03, 0x11},
...
LOCAL SENSOR_REG_T sr300pc20_fps_24fix[] ={
// ==========================================================
//	Fixed 24 FPS
// ==========================================================
    {0x03, 0x00},
...
LOCAL SENSOR_REG_T sr300pc20_fps_30fix[]={
// ==========================================================
//	Fixed 30FPS
// ==========================================================
    {0x03, 0x00},
...
LOCAL SENSOR_REG_T sr300pc20_720_480_30fix[]={
// ==========================================================
//	Fixed 30FPS
// ==========================================================
    {0x03, 0x00},
    ...
    {0x03, 0x19}, /*Scaler*/
   	...
   	{0x12, 0x06},
   	{0x13, 0x01},
   	{0x20, 0x02}, /*zoom width 720*/
   	{0x21, 0xD0},
   	{0x22, 0x02}, /*zoom height 540*/
   	{0x23, 0x1c},
   	{0x24, 0x00}, /*stx*/
   	{0x25, 0x00},
   	{0x26, 0x00}, /*sty*/
...
//LOCAL SENSOR_REG_T sr300pc20_fps_mode_tab[][50]=

LOCAL SENSOR_REG_T sr300pc20_effect_off[]=
{
	//EF_NOMAL
	{0x03, 0x10},
	{0x11, 0x03},
...
LOCAL SENSOR_REG_T sr300pc20_effect_mono[]=
{
	//EF_MONO
	{0x03, 0x10},
	{0x11, 0x03},
	...
	LOCAL SENSOR_REG_T sr300pc20_effect_sepia[]=
{
	//EF_sepia
	{0x03, 0x10},
	{0x11, 0x03},
...
LOCAL SENSOR_REG_T sr300pc20_effect_negative[]=
{
	//EF_Negative
	{0x03, 0x10},
	{0x11, 0x03},
...
//LOCAL SENSOR_REG_T sr300pc20_image_effect_tab[][15]=;
LOCAL SENSOR_REG_T sr300pc20_wb_auto[] =
{
	/*==========================================================
	//	CAMERA_WB_AUTO  (0/5)
	//==========================================================*/
...
LOCAL SENSOR_REG_T sr300pc20_wb_daylight[] =
{
	/*==========================================================
...
LOCAL SENSOR_REG_T sr300pc20_wb_cloudy[] =
{
	/*==========================================================
	...
	{0x19, 0x8e}, /*indoor R gain Max*/
	{0x1a, 0x5d}, /*indoor B gain Min*/
	{0x1b, 0x5f}, /*indoor B gain Max*/
	{0x03, 0xc5},
	{0x10, 0xb1},
	{0xff, 0xff},
};
LOCAL SENSOR_REG_T sr300pc20_wb_incandescent[] =
{
     		/*==========================================================
    ...
    {0x19, 0x45}, /*indoor R gain Max*/
    {0x1a, 0xa7}, /*indoor B gain Min*/
    {0x1b, 0xa8}, /*indoor B gain Max*/
    {0x03, 0xc5},
    {0x10, 0xb1},
    {0xff, 0xff},
...
LOCAL SENSOR_REG_T sr300pc20_wb_fluorescent[] =
{
	/*==========================================================
	...
	{0x12, 0x03}, /*adaptive off*/
	{0x03, 0xc6}, /*Page c6*/
	{0x18, 0x5f}, /*indoor R gain Min*/
	{0x19, 0x60}, /*indoor R gain Max*/
...
//LOCAL SENSOR_REG_T sr300pc20_awb_tab[][20]=
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_0[] =
{//level 1
	{0x03, 0xd9},
	{0x17, 0xd0},
	{0xff, 0xff},
};
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_1[] =
{//level 2
	{0x03, 0xd9},
	{0x17, 0xc0},
	{0xff, 0xff},
...
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_2[] =
{//level 3
	{0x03, 0xd9},
	{0x17, 0xb0},
	{0xff, 0xff},
};
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_3[] =
{//level 4
	{0x03, 0xd9},
	{0x17, 0xa0},
	{0xff, 0xff},
};
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_4[] =
{//level 5
	{0x03, 0xd9},
	{0x17, 0x00},
	{0xff, 0xff},
};
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_5[] =
{//level 6
	{0x03, 0xd9},
	{0x17, 0x14},
	{0xff, 0xff},
...
LOCAL SENSOR_REG_T   sr300pc20_brightness_tab_6[] =
{//level 7
	{0x03, 0xd9},
	{0x17, 0x28},
	{0xff, 0xff},
};
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_7[] =
{//level 8
	{0x03, 0xd9},
	{0x17, 0x3c},
	{0xff, 0xff},
};
LOCAL SENSOR_REG_T  sr300pc20_brightness_tab_8[] =
{//level 9
	{0x03, 0xd9},
	{0x17, 0x50},
	{0xff, 0xff},
...
//LOCAL SENSOR_REG_T sr300pc20_brightness_tab[][10]=
LOCAL const SENSOR_REG_T sr300pc20_contrast_m_3[]	=
{
	{0x03,0x10},  ///-3
	{0x48,0x50},
	{0xff, 0xff}
};
LOCAL const SENSOR_REG_T sr300pc20_contrast_m_2[] =
{
	{0x03,0x10},  ///-2
	{0x48,0x60},
	{0xff, 0xff}
};
LOCAL const SENSOR_REG_T sr300pc20_contrast_m_1[]=
{
	{0x03,0x10},  ///-1
	{0x48,0x70},
	{0xff, 0xff}
};
LOCAL const SENSOR_REG_T sr300pc20_contrast_0[] =
{
	{0x03,0x10},  ///0
	{0x48,0x80}, // 80
	{0xff, 0xff}
};
LOCAL const SENSOR_REG_T sr300pc20_contrast_p_1[] =
{
	{0x03,0x10},  ///1
	{0x48,0xa0},
	{0xff, 0xff}
};
LOCAL const SENSOR_REG_T sr300pc20_contrast_p_2[] =
{
	{0x03,0x10},  ///2
	{0x48,0xb0},
	{0xff, 0xff}
};
LOCAL const SENSOR_REG_T sr300pc20_contrast_p_3[] =
{
	{0x03,0x10},  ///3
	{0x48,0xc0},
	{0xff, 0xff}
};
//LOCAL const SENSOR_REG_T sr300pc20_contrast_tab[][15]=
LOCAL  const  SENSOR_REG_T  sr300pc20_scene_off[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_portrait[]=
{
	// ==========================================================
...
//Party/Indoor
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_landscape[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_party[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_sunset[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_dawn[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_fall[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_nightshot[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_firework[]=
{
		// ==========================================================
	...
	/*Shutter Setting*/
		{0x03, 0xc4},
		{0x19, 0x3c}, /*Band1 Gain 33.33fps*/
		{0x1a, 0x40}, /*Band2 Gain 20fps*/
		{0x1b, 0x46}, /*Band3 Gain 12.5fps*/
	/*Shutter Setting*/
		{0x22, 0x00}, /*Bnd2*/
		{0x23, 0x29},
		{0x24, 0x32},
...
//LOCAL  const  SENSOR_REG_T   sr300pc20_scene_text[]=
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_candle[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_sports[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_beach[]=
{
		// ==========================================================
...
LOCAL  const  SENSOR_REG_T   sr300pc20_scene_backlight[]=
{
		// ==========================================================
...
//LOCAL SENSOR_REG_T sr300pc20_scene_mode_tab[][150]=

LOCAL SENSOR_REG_T sr300pc20_metering_normal[]=
{
	// ==========================================================
	//	Metering Normal
	// ==========================================================
...
LOCAL SENSOR_REG_T sr300pc20_metering_spot[]=
{
	// ==========================================================
	//	Metering Spot
	// ==========================================================
...
LOCAL SENSOR_REG_T sr300pc20_metering_center[]=
{
	// ==========================================================
...
//LOCAL SENSOR_REG_T sr300pc20_metering_mode_tab[][50]=


LOCAL SENSOR_REG_T sr300pc20_dtp_off[]=
{
// ==========================================================
//	DTP OFF
// ==========================================================
...
LOCAL SENSOR_REG_T sr300pc20_dtp_on[]=
{
// ==========================================================
//	DTP ON
// ==========================================================
...
//LOCAL SENSOR_REG_T sr300pc20_dtp_mode_tab[][50]=

LOCAL SENSOR_REG_T sr300pc20_dtp_mode_init[] =
{
	{0x03, 0x00},
	{0x60, 0x05},
	{0xff, 0xff}

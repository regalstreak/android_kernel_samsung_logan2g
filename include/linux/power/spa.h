...
#define SPA_CHARGE_TIMER_90MIN		(HZ*60*90)

#define SPA_CHARGE_TIMER_5HOUR		(HZ*60*60*5)

#define SPA_CHARGE_TIMER_6HOUR		(HZ*60*60*6)

#define SPA_CHARGE_TIMER_8HOUR		(HZ*60*60*8)

#define	SPA_CHARGE_TIMER_10HOUR		(HZ*60*60*10)



#define SPA_CHARGING_STOP_HIGH_TEMPERATURE	60000000  

#define SPA_CHARGING_RESTART_HIGH_TEMPERATURE	41000000 

#define SPA_CHARGING_RESTART_LOW_TEMPERATURE 0

#define SPA_CHARGING_STOP_LOW_TEMPERATURE	-4000000


#if defined(CONFIG_MACH_KYLETD)
#define SPA_CHARGING_RESTART_VOLTAGE	4300
#elif defined(CONFIG_MACH_VASTOI)
#define SPA_CHARGING_RESTART_VOLTAGE	4150
#elif defined(CONFIG_MACH_NEVISTD)
#define SPA_CHARGING_RESTART_VOLTAGE	4150

#define SPA_BACK_CHARGING_FEATURE    // 20130218 BST xiaobin.lai add back charging for nevis.

#else
#define SPA_CHARGING_RESTART_VOLTAGE	4290
#endif
...
enum {
	SPA_STATE_NORMAL_CHARGING = 0,
	SPA_STATE_BACK_CHARGING,
	SPA_STATE_STANDBY,
	SPA_STATE_RESTART_CHARGING,
};
void spa_bat_enter_backcharging(struct spa_driver_data *info);
void spa_bat_enter_chargefullstate(struct spa_driver_data *info);
#endif
